...
def mostrar_cv_resaltado(texto: str, coincidencias: Set[str], nombre: str):
    ...
    texto_widget = tk.Text(ventana_cv, wrap="word", width=100, height=40)
    ...
    texto_widget.tag_config("coincidencia", background="yellow", foreground="black")
...
def filtrar_cvs():
    ...
    movidos = 0
    for archivo, coincidencias, texto_pdf in resultados:
